...
- _Security Guardrail:_ Your resume text is processed strictly in-memory and is **never** saved to database or log stores.
...
3. **Metadata Pre-Filtering:** Queries are filtered by company tags _before_ running vector search, ensuring semantic context stays bounded.
